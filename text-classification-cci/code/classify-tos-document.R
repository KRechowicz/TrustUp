...
tos_model = readRDS("models/terms-of-service/tos_rf 5.RDS")


whoop_filename = "input/terms-of-service/whoop-tos.txt"
fitbit_filename = "input/privacy-policy/fitbit-pp.txt"
cellartracker_filename = "input/privacy-policy/cellartracker-pp.txt"

filename_of_tos_txt_document_to_classify = cellartracker_filename
...
tos_dtm = removeSparseTerms(tos_dtm, sparse = .999)
