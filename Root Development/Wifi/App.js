...
export default class App extends Component<Props> {
  ...
  toggleSwitch = () => {
    ...
    if (this.state.isOnPort21ToggleSwitch) {
      port_array.push('21');
    }
    if (this.state.isOnPort22ToggleSwitch) {
      port_array.push('22');
    }
    if (this.state.isOnPort25ToggleSwitch) {
      port_array.push('25');
    }
    if (this.state.isOnPort80ToggleSwitch) {
      port_array.push('80');
    }
    if (this.state.isOnPort443ToggleSwitch) {
      port_array.push('443');
    }
    if (this.state.isOnPort3389ToggleSwitch) {
      port_array.push('3389');
    }
